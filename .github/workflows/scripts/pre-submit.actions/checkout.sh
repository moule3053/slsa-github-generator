...
# TODO(github.com/moule3053/slsa-framework/slsa-github-generator/issues/626): Check workflows as well and not just actions.
# TODO(github.com/moule3053/slsa-framework/slsa-github-generator/issues/626): Disallow checkouts for repos other than the repo that triggered the action(i.e. github.repository).
results=$(
    grep -r \
        --include='*.yml' \
        --include='*.yaml' \
